...
// ---------------------------------------------- //
    ...
    boolean exito = userDat.modificar(usuario);
...
// Manejar las peticiones DELETE
    ...
    boolean exito = userDat.eliminar(id);
